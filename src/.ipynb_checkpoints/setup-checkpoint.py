...
from ssgsea_distance import prepare_ssGSEA_input, _get_geneset_distance, ssgsea_output_statistics
        ...
        for i, (geneexpr_level, geneset_level) in enumerate(modality_combinations):
            ...
            for weights, weight_name in zip(weights_list, weight_names):
                ...
                try:
                    ...
                    if cluster:
                        for k_val in k:
                            clustering.cluster(processed_adata, linkage='complete', k=k_val)
...
def multimodal_distance(
    ...
    if geneset_level:        
        ...
        ssgsea_dist_scaled, ssgsea_dist = _get_geneset_distance(adata, ssgsea_df, weights)
